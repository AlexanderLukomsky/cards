          ...
          {cards.isInitialized && (
            <>
              <div className="cards__title-box">
                <IconButton onClick={onClickBackHandler}>
                  <ArrowBackIcon />
                </IconButton>
              ...
              <div className="cards__header">
                ...
                <div
                  className={`cards__search-settings${
                    openSetting ? " open" : ""
                  }`}
                >
                  <IconButton
                    className="cards__search-settings_close"
                    onClick={onOpenSettings}
                  >
                    <CloseIcon />
                  </IconButton>
                  <RadioGroup
                    value={cards.searchBy}
                    onChange={setSearchSettings}
                  >
                    <FormControlLabel
                      value="question"
                      control={<Radio disabled={!openSetting} />}
                ...
                {auth.authData._id === cards.data.packUserId && (
                  <AddNewCardModal cardsPack_id={packId!} />
                )}
              </div>
              ...
              <div className="cards__footer">
                <PacksPagination
                  ...
                  totalCount={
                    cards.data.cardsTotalCount === 0
                      ? 5
                      : cards.data.cardsTotalCount
                  }
