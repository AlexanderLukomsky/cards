...
export const PacksList: React.FC<PropsType> = React.memo(
  ({ packs, progressStatus }) => {
    const [isOpenTrainingModal, setIsOpenTrainingModal] = useState(false);
    const columns = [
      { title: "Name", align: "left" },
      { title: "Cards", align: "right" },
      { title: "Last Updated", align: "right" },
      { title: "Created by", align: "center" },
    ...
    return (
      <div className="packs__list packs-list">
        ...
        {isOpenTrainingModal && (
          <PacksCardsTrainingModal
            onCloseModal={onCloseTrainingModal}
