...
export const Registration = () => {
   ...
   const onSubmitForm = async () => {
      const errors = validator({ email: emailValue, password: passwordValue, confirmPassword: confirmPasswordValue })
   ...
   return (
      <div className="registration forms-form">
         ...
         <div className="registration__buttons">
            <NavLink className={"registration__button-home"}
               to={_pagesPath.MAIN}
            >
               Home page
            </NavLink>
            <CustomButton
               ...
               disabled={!!errors.email || !!errors.password || !!errors.confirmPassword || authState.authStatus === 'loading'}
