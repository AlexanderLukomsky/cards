...
export const ProfilePerson: React.FC<PropsType> = React.memo(
  ({ offEditMode }) => {
    ...
    return (
      <div className="profile-person">
        ...
        {!offEditMode && (
          <button
            className="profile-person__edit-btn"
        ...
        >
          ...
          <TextField
            variant="standard"
            label={"new profile img"}
            value={imgUrl}
            onChange={onChangeImgHandler}
          />
          <span
            className={`profile-person__img-description${
              error ? " error" : ""
            }`}
          >
